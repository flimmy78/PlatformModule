...
#include "FREQBDcuGUI_global.h"
#include "../../Common/LxTsspCommonDefinition.h"
#include "../../Common/DataStruct2311.h"

#include "../../Common/DeviceMap.h"

#define MODULENAME      ("频率基准源监控")

class FREQBDCUGUISHARED_EXPORT FREQBDcuGUI : public ILxTsspShow
{
public:
    FREQBDcuGUI(TLxTsspObjectInfo ObjectInfo);
