...
#include "USBBBE_PMModuSetGUI_global.h"
#include "../../Common/LxTsspCommonDefinition.h"
#include "../../Common/DataStruct2311.h"
#include  "../../Common/DeviceMap.h"

#define MODULENAME "USBBBE调制参数设置"
#define CMDNAME "过程控制命令"
class USBBBE_PMMODUSETGUISHARED_EXPORT USBBBE_PMModuSetGUI : public ILxTsspShow
{

public:
    USBBBE_PMModuSetGUI(TLxTsspObjectInfo ObjectInfo);
...
protected:
    ...
    quint64 m_ParaModuID;
    quint64 m_StatusModuID;
