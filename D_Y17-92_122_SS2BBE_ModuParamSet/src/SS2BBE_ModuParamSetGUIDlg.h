...
public:
    ...
    //设置对象信息
    void SetObjInfo(TLxTsspObjectInfo ObjectInfo, DOPPLERCOMPENSATE& doppler);
    //保存参数宏
...
public slots:
    ...
    void on_comboBox_ChannelOutputCtrlM_currentIndexChanged(int index);
    void on_pushButton_PublicUnitSet_clicked();
    void on_checkBox_dopplerSw_clicked();
    void on_checkBox_dopplerSw_toggled(bool checked);
//    void on_lineEdit_DopplerPredFreT_textChanged(const QString &arg1);
};
