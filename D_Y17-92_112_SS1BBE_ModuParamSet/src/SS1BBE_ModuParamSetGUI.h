...
#include "SS1BBE_ModuParamSetGUI_global.h"
#include "../../Common/LxTsspCommonDefinition.h"

#include "../../Common/DataStruct2311.h"
#include "../../Common/DeviceMap.h"
#define MODULENAME ("模式1调制参数设置")
#define CMDNAME ("过程控制命令")

class SS1BBE_MODUPARAMSETGUISHARED_EXPORT SS1BBE_ModuParamSetGUI : public ILxTsspShow
{

public:
    SS1BBE_ModuParamSetGUI(TLxTsspObjectInfo ObjectInfo);
...
protected:
    ...
    quint64 m_ParaModuID;      //参数框架ID
    quint64 m_StatusModuID;    //参数状态ID
