...
#include "ZEROSTDDcuGUI_global.h"
...
#define MODULENAME      ("校零信标一体机监控")

class ZEROSTDDCUGUISHARED_EXPORT ZEROSTDDcuGUI : public ILxTsspShow
{
public:
    ZEROSTDDcuGUI(TLxTsspObjectInfo ObjectInfo);
