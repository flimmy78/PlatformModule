#ifndef ZEROSTDDCUGUIDLG_H
#define ZEROSTDDCUGUIDLG_H
...
namespace Ui {
    class ZEROSTDDcuGUIDlg;
}

class ZEROSTDDcuGUIDlg : public QDialog
{
    Q_OBJECT

public:
    explicit ZEROSTDDcuGUIDlg(QWidget *parent = 0);
...
private:
    Ui::ZEROSTDDcuGUIDlg *ui;

    QString m_strTitle;
    TLxTsspObjectInfo m_ObjectInfo;
    ILxTsspLogManager* m_pILxTsspLogManager;

    ZEROCALIBBEACONPara  m_ComPara;          //参数
    ZEROCALIBBEACONStatu *m_pComStatus;      //状态参数
