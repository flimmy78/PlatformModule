...
#include "TCPNCodeSetGUI_global.h"
#include "../../Common/LxTsspCommonDefinition.h"

#include "../../Common/DataStruct2311.h"
#include "../../Common/DeviceMap.h"
#define MODULENAME ("单遥控扩频码参数设置")

//参数描述信息
class TCPNCODESETGUISHARED_EXPORT TCPNCodeSetGUI : public ILxTsspShow
{

public:
    TCPNCodeSetGUI(TLxTsspObjectInfo ObjectInfo);
...
protected:
    ...
    quint64 m_ParaTCPNCID;
    quint64 m_StatusTCPNCID;
