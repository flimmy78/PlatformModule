...
extern "C" int GetConfigFormat(QString& strConfigFormat)
{
    ...
    strConfigFormat = QString(
            "<Module Name=\"USBBBE_TMCJRecSetGUI.so\" StationID=\"2311\" SubSysID=\"04\" DevID=\"0401\" Note=\"%1\"> \n "
            "<Object ID=\"5142\" Num=\"1\" IndexStart=\"0\" Alias =\" \" Note=\"参数设置\">...</Object> \n ... \n </Module>").arg(MODULENAME);
    return 1;
}
    ...
    for(int i=0; i<nodeList.length(); i++)
    {
        ...
        if(usObjID == 0x5142)
        {
            for(int k=iStart; k<iStop; k++)
            {
                ...
                g_ObjectList.insert(ui64ObjectID, new USBBBE_TMCJRecSetGUI(ObjectInfo));
            }
        }
    }
