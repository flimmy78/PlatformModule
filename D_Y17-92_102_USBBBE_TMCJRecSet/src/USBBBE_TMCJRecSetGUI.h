...
#include "USBBBE_TMCJRecSetGUI_global.h"
...
#define MODULENAME      ("USBBBE中频接收机参数设置")

class USBBBE_TMCJRECSETGUISHARED_EXPORT USBBBE_TMCJRecSetGUI : public ILxTsspShow
{

public:
    USBBBE_TMCJRecSetGUI(TLxTsspObjectInfo ObjectInfo);
...
protected:
    ...
    quint64 m_ParaTMCJID;
    quint64 m_StatusTMCJID;
