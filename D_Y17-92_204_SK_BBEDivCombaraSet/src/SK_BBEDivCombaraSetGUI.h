...
#include "SK_BBEDivCombaraSetGUI_global.h"
...
#define MODULENAME      ("分集合成参数设置")



class SK_BBEDivCombaraSetGUISHARED_EXPORT SK_BBEDivCombaraSetGUI : public ILxTsspShow
{
public:
    SK_BBEDivCombaraSetGUI(TLxTsspObjectInfo ObjectInfo);
