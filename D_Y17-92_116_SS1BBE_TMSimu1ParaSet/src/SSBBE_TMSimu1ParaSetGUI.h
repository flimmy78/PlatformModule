...
#include "SSBBE_TMSimu1ParaSetGUI_global.h"
...
class SSBBE_TMSIMU1PARASETGUISHARED_EXPORT SSBBE_TMSimu1ParaSetGUI : public ILxTsspShow
{

public:
    SSBBE_TMSimu1ParaSetGUI(TLxTsspObjectInfo ObjectInfo);
