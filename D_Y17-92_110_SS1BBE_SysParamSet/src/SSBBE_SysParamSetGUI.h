...
#include "SSBBE_SysParamSetGUI_global.h"
...
#define MODULENAME   ("扩频1系统工作参数设置")
#define SS1_TARGET_NUM ("扩频目标数")
#define CMDNAME4 ("过程控制命令4")
class SSBBE_SYSPARAMSETGUISHARED_EXPORT SSBBE_SysParamSetGUI : public ILxTsspShow
{
public:
    SSBBE_SysParamSetGUI(TLxTsspObjectInfo ObjectInfo);
