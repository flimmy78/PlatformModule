...
extern "C" int GetConfigFormat(QString& strConfigFormat)
{
    ...
    strConfigFormat =
            QString("<Module Note=\"%1\" DeviceID=\"700\" SubSysID=\"01\" Name=\"liSS2RSPDcu.so\" StationID=\"2311\"> \n"
                    "<Object Note=\"%1\" Num=\"1\" Alias=\" \" ID=\"6006\" IndexStart=\"0\"/> \n"
