#ifndef SS2RSPDCUGUIDLG_H
#define SS2RSPDCUGUIDLG_H
...
namespace Ui {
    class SS2RSPDcuGUIDlg;
}

class SS2RSPDcuGUIDlg : public QDialog
{
    Q_OBJECT
public:
    explicit SS2RSPDcuGUIDlg(QWidget *parent = 0);
