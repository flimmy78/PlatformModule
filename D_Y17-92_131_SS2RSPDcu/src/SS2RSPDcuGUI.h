...
#define MODULENAME      ("非相干扩频联试应答机监控")


class SS2RSPDCUGUISHARED_EXPORT SS2RSPDcuGUI : public ILxTsspShow
{
public:
    SS2RSPDcuGUI(TLxTsspObjectInfo ObjectInfo);
