...
#include "TCBBE_SysParamSetGUI_global.h"
...
#define MODULENAME   ("单遥控系统工作参数设置")
#define SS2_TARGET_NUM ("扩频目标数")
class SS2BBE_SYSPARAMSETGUISHARED_EXPORT SS2BBE_SysParamSetGUI : public ILxTsspShow
{
public:
    SS2BBE_SysParamSetGUI(TLxTsspObjectInfo ObjectInfo);
...
public:
    ...
    */
    ...
    bool isAK(unsigned short localDID, int &connectIndex);
protected:
    //对象信息
    ...
    quint64 m_targetNumID; //获取目标数
    ParaStruct m_ParaSetStruct[5][60];  //保存参数描述信息
