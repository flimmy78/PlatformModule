...
#include "TCBBE_ModuParamSetGUI_global.h"
#include "../../Common/LxTsspCommonDefinition.h"

#include "../../Common/DataStruct2311.h"
#include "../../Common/DeviceMap.h"
#define  MODULENAME  ("单遥控调制参数设置")

class SS2BBE_MODUPARAMSETGUISHARED_EXPORT SS2BBE_ModuParamSetGUI : public ILxTsspShow
{

public:
    SS2BBE_ModuParamSetGUI(TLxTsspObjectInfo ObjectInfo);
