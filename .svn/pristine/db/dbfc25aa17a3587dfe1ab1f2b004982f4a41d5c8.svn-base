#ifndef SSBBE_TCPARASETGUIDLG_H
#define SSBBE_TCPARASETGUIDLG_H
...
namespace Ui {
class SSBBE_TCParamSetGUIDlg;
}

class SSBBE_TCParamSetGUIDlg : public QDialog
{
    Q_OBJECT

public:
    explicit SSBBE_TCParamSetGUIDlg(QWidget *parent = 0);
    QSize sizeHint() const;
    ~SSBBE_TCParamSetGUIDlg();
...
private:
    Ui::SSBBE_TCParamSetGUIDlg *ui;

    QString m_strTitle;
    TLxTsspObjectInfo m_ObjectInfo;
    ILxTsspLogManager* m_pILxTsspLogManager;

    SMCU::MCSSSTCParamStruct4 m_MCSSSTCParam;       //参数

    SMCU::MCSSSTCStatusStruct4* m_MCSSSTCStatus;       //状态
