...
#include "SS1BBE_CjCsParamSetGUI_global.h"
...
#define MODULENAME ("模式1测距测速参数设置")

class SS1BBE_CJCSPARAMSETGUISHARED_EXPORT SS1BBE_CjCsParamSetGUI : public ILxTsspShow
{

public:
    SS1BBE_CjCsParamSetGUI(TLxTsspObjectInfo ObjectInfo);
