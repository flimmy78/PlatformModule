...
#include "USBBBE_CodeTMParaSetGUI_global.h"
...
#define MODULENAME  ("USBBBE遥测参数设置")

class USBBBE_CODETMPARASETGUISHARED_EXPORT USBBBE_CodeTMParaSetGUI : public ILxTsspShow
{
public:
    USBBBE_CodeTMParaSetGUI(TLxTsspObjectInfo ObjectInfo);
