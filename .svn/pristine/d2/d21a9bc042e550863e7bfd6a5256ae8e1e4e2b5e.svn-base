...
#define MODULENAME      ("标准TTC联试应答机监控")

class USBRSPDCUGUISHARED_EXPORT USBRSPDcuGUI : public ILxTsspShow
{
public:
    USBRSPDcuGUI(TLxTsspObjectInfo ObjectInfo);
...
protected:
    ...
    quint64 m_ParaMarcoComSynID;    //参数状态ID
