#ifndef TESTNET_SWITCHGUIDLG_H
#define TESTNET_SWITCHGUIDLG_H
...
namespace Ui {
    class TestNet_SwitchGUIDlg;
}

class TestNet_SwitchGUIDlg : public QDialog
{
    Q_OBJECT
public:
    explicit TestNet_SwitchGUIDlg(QWidget *parent = 0);
    QSize sizeHint() const;
    ~TestNet_SwitchGUIDlg();
...
private:
    Ui::TestNet_SwitchGUIDlg *ui;

    QString m_strTitle;
    TLxTsspObjectInfo m_ObjectInfo;
    ILxTsspLogManager* m_pILxTsspLogManager;

    TEST_SWMATPara m_TestSWMatPara;  //测试开关矩阵状态参数
    TEST_SWMATStatu *m_pTestSWMatStatus;  //测试开关矩阵显示响应信息
    ...
    quint64 m_ParaSwitchCodeSynID;           //参数设置信息ID
    quint64 m_StatusSwitchCodeSynID;        //状态响应信息ID
