...
#include "SS2BBE_OutPutSelSetGUI_global.h"
...
class SS2BBE_OUTPUTSELSETGUISHARED_EXPORT SS2BBE_OutPutSelSetGUI : public ILxTsspShow
{

public:
    SS2BBE_OutPutSelSetGUI(TLxTsspObjectInfo ObjectInfo);
