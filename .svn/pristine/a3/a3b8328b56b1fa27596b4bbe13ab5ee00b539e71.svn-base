...
#include "SSBBE_OutPutSelSetGUI_global.h"
...
class SSBBE_OUTPUTSELSETGUISHARED_EXPORT SSBBE_OutPutSelSetGUI : public ILxTsspShow
{

public:
    SSBBE_OutPutSelSetGUI(TLxTsspObjectInfo ObjectInfo);
