#ifndef TTCDEVCTLINTERFACEGUIDLG_H
#define TTCDEVCTLINTERFACEGUIDLG_H

#include <QDialog>
#include "DevCtlInterfaceGUI.h"
#include <QTimer>
namespace Ui {
class TTCDevCtlInterfaceGUIDlg;
}

class TTCDevCtlInterfaceGUIDlg : public QDialog
{
    Q_OBJECT

public:
    explicit TTCDevCtlInterfaceGUIDlg(QWidget *parent = 0);
    ~TTCDevCtlInterfaceGUIDlg();
protected:

private:
    Ui::TTCDevCtlInterfaceGUIDlg *ui;
    QString m_strTitle;
...
#endif // TTCDEVCTLINTERFACEGUIDLG_H
