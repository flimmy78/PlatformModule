...
#include "TestNet_SwitchGUI_global.h"
#include "../../Common/LxTsspCommonDefinition.h"
#include "../../Common/DataStruct2311.h"

#include "../../Common/DeviceMap.h"

#define MODULENAME      ("测试开关矩阵监控")

class TESTNET_SWITCHGUISHARED_EXPORT TestNet_SwitchGUI : public ILxTsspShow
{
public:
    TestNet_SwitchGUI(TLxTsspObjectInfo ObjectInfo);
...
public:
    ...
    */
     ...
     * 当表示单元数据时，最后两CDeviceMap m_DeviceMap;
    quint64 m_ParaComSynID;      //参数框架ID
    quint64 m_StatusComSynID;    //参数状态ID个字节值填0。
