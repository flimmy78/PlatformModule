...
#include "DDTBBE_RecSet_global.h"
#include "../../Common/LxTsspCommonDefinition.h"

#include "../../Common/DataStruct2311.h"
#include "../../Common/DeviceMap.h"

#define MODULENAME      ("数传接收机参数设置")

class DDTBBE_RECSETGUISHARED_EXPORT DDTBBE_RecSetGUI : public ILxTsspShow
{

public:
    DDTBBE_RecSetGUI(TLxTsspObjectInfo ObjectInfo);
