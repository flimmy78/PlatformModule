...
#define MODULENAME      ("铷钟机箱监控")

class RCLOCKDCUGUISHARED_EXPORT RCLOCKDcuGUI : public ILxTsspShow
{
public:
    RCLOCKDcuGUI(TLxTsspObjectInfo ObjectInfo);
