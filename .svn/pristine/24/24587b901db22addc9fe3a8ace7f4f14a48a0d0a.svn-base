...
#include "Net_SwitchGUI_global.h"
#include "../../Common/LxTsspCommonDefinition.h"
#include "../../Common/DataStruct2311.h"
#include "../../Common/DeviceMap.h"

#define MODULENAME      ("下行中频开关矩阵监控")


class NET_SWITCHGUISHARED_EXPORT Net_SwitchGUI : public ILxTsspShow
{
public:
    Net_SwitchGUI(TLxTsspObjectInfo ObjectInfo);
