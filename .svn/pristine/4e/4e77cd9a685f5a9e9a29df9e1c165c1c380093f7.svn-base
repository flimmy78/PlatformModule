...
#include "SSBBE_TMParaSetGUI_global.h"
...
class SSBBE_TMPARASETGUISHARED_EXPORT SSBBE_TMParaSetGUI : public ILxTsspShow
{

public:
    SSBBE_TMParaSetGUI(TLxTsspObjectInfo ObjectInfo);
