#ifndef DDTBBE_SYSPARASETGUI_H
#define DDTBBE_SYSPARASETGUI_H

#include "DDTBBE_SysParaSet_global.h"
...
#define MODULENAME      ("DDT_BBE系统参数设置")
#define CMDNAME ("过程控制命令")
#define SS1_TARGET_NUM ("扩频目标数")

class DDTBBE_SYSPARASETGUISHARED_EXPORT DDTBBE_SysParaSetGUI : public ILxTsspShow
{
public:
    DDTBBE_SysParaSetGUI(TLxTsspObjectInfo ObjectInfo);
...
protected:
    ...
    quint64 m_ParaMCSSysSynID;      //公共参数单元界面ID
    quint64 m_StatusParaMCSSysSynID;    //公共单元状态数据元素ID
