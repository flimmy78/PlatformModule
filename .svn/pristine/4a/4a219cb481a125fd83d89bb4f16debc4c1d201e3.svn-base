...
#include "RecordMonitorGUI_global.h"
#include "../../Common/LxTsspCommonDefinition.h"
#include "../../Common/DataStruct2311.h"
#include "../../Common/DeviceMap.h"
#include "../../Common/Log.h"

#define MODULENAME ("检前记录设备监控")

class RECORDMONITORGUISHARED_EXPORT RecordMonitorGUI : public ILxTsspShow
{
public:
    RecordMonitorGUI(TLxTsspObjectInfo ObjectInfo);
