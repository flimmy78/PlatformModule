...
#include "SSBBE_TCParamSetGUI_global.h"
#include "../../Common/LxTsspCommonDefinition.h"

#include "../../Common/DataStruct2311.h"
#include "../../Common/DeviceMap.h"
#define MODULENAME  ("扩频遥控参数设置")

class SSBBE_TCPARASETGUISHARED_EXPORT SSBBE_TCParamSetGUI : public ILxTsspShow
{

public:
    SSBBE_TCParamSetGUI(TLxTsspObjectInfo ObjectInfo);
