...
#include "SLDCDcuGUI_global.h"
#include "../../Common/LxTsspCommonDefinition.h"
#include "../../Common/DataStruct2311.h"

#include "../../Common/DeviceMap.h"

#define MODULENAME      ("射频分路组合监控")

class SLDCDCUGUISHARED_EXPORT SLDCDcuGUI : public ILxTsspShow
{
public:
    SLDCDcuGUI(TLxTsspObjectInfo ObjectInfo);
