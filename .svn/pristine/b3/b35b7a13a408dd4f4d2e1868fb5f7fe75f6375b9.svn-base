#ifndef SS1BBE_RCVPARAMSETGUIDLG_H
#define SS1BBE_RCVPARAMSETGUIDLG_H
...
namespace Ui
{
    class SS1BBE_RcvParamSetGUIDlg;
}

class SS1BBE_RcvParamSetGUIDlg : public QDialog
{
    Q_OBJECT

public:
    explicit SS1BBE_RcvParamSetGUIDlg(QWidget *parent = 0);
    QSize sizeHint() const;
    ~SS1BBE_RcvParamSetGUIDlg();
...
private:
    Ui::SS1BBE_RcvParamSetGUIDlg *ui;

    QString m_strTitle;
    TLxTsspObjectInfo m_ObjectInfo;
    ILxTsspLogManager* m_pILxTsspLogManager;

    SMCU::MCSSSRevParamStruct4 m_MCSSSRevParam;       //参数

    SMCU::MCSSSRevStatusStruct4* m_MCSSSRevStatus;     //状态
...
#endif // SS1BBE_RCVPARAMSETGUIDLG_H
