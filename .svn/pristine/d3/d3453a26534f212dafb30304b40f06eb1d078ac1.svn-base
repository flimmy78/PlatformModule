...
#define _L_BUFFER_LENGTH		(1024 * 8)
...
typedef union _data_context_
{
    ...
    BYTE answer;
    ALTER alter;//变频器
    ADJUST_ALTER adjustAlter;//校验变频器
...
typedef struct _SS2BBEGROUPPARA
{
    WORD seq;
    WORD wUnit1Head;
    SMCU2::MCSSysParamStruct4 GlobalSetPara1;
    WORD wUnit1End;
    WORD wUnit2Head;
    SMCU2::MCSRevParamStruct4 mcsSSRec2;
    WORD wUnit2End;
    WORD wUnit3Head;
    SMCU2::MCSUpModulParamStruct4 UpModul3;
    WORD wUnit3End;
    WORD wUnit4Head;
    SMCU2::MCSSSB2CjParamStruct4 MCSSSCjParam4;
    WORD wUnit4End;
    WORD wUnit5Head;
    SMCU2::MCSSSTCParamStruct4 MCSSSTCParam5;
    WORD wUnit5End;
    WORD wUnit6Head;
    SMCU2::MCSSSB2TMParamStruct4 MCSSSTMParam6;
    WORD wUnit6End;
//    WORD wUnit7Head;
//    SSBBECTMEmulatorSetStruct mcsSSTMEmulator;
//    WORD wUnit7End;
    WORD wUnit8Head;
    SMCU2::MCSSSB2TMSimulParamStruct4 MCSSSTMSimulParam8;
    WORD wUnit8End;
    WORD wUnit9Head;
    SMCU2::MCSSSB2PNCodeStruct4 mSSPNCode9;
    WORD wUnit9End;
}SS2BBEGROUPPARA, *PSS2BBEGROUPPARA;
