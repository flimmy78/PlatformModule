...
#include "TTCRemoteInterface_global.h"
#include "cbaseband.h"
...
public:
    ...
    void ProcessGroupDataTrans(ILxTsspParameterMacro* macroObj, DATACONTENT msg, QString);
    void ProcessGroupTTC(ILxTsspParameterMacro* macroObj, DATACONTENT msg, QString);
    void ProcessGroupSMCU1(ILxTsspParameterMacro* macroObj, DATACONTENT msg, QString);
    void ProcessGroupSMCU2(ILxTsspParameterMacro* macroObj, DATACONTENT msg, QString);
    void ProcessGroupTC(ILxTsspParameterMacro* macroObj, DATACONTENT msg, QString);
