#ifndef FREQBDCUGUIDLG_H
#define FREQBDCUGUIDLG_H
...
namespace Ui {
    class FREQBDcuGUIDlg;
}

class FREQBDcuGUIDlg : public QDialog
{
    Q_OBJECT
public:
    explicit FREQBDcuGUIDlg(QWidget *parent = 0);
...
private:
    Ui::FREQBDcuGUIDlg *ui;

    QString m_strTitle;
    TLxTsspObjectInfo m_ObjectInfo;
    ILxTsspLogManager* m_pILxTsspLogManager;

    FREQBDCUPara m_FreqBDcuPara;  //状态参数
    FREQBDCUStatu *m_pFreqBDcuStatus;  //显示响应信息
