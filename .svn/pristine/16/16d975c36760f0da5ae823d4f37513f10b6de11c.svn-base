...
#include "DDTBBE_ModSourceSetGUI_global.h"
#include "../../Common/LxTsspCommonDefinition.h"

#include "../../Common/DataStruct2311.h"
#include "../../Common/DeviceMap.h"

#define MODULENAME  ("数传信号源参数设置")



class DDTBBE_MODSOURCESETGUISHARED_EXPORT DDTBBE_ModSourceSetGUI : public ILxTsspShow
{

public:
    DDTBBE_ModSourceSetGUI(TLxTsspObjectInfo ObjectInfo);
