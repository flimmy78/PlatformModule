...
#include "USBBBE_ZKsetGUI_global.h"
#include "../../Common/LxTsspCommonDefinition.h"

#include "../../Common/DataStruct2311.h"
#include "../../Common/DeviceMap.h"
#define MODULENAME "USBBBE遥控参数设置"

class USBBBE_ZKSETGUISHARED_EXPORT USBBBE_ZKsetGUI : public ILxTsspShow
{

public:
    USBBBE_ZKsetGUI(TLxTsspObjectInfo ObjectInfo);
...
protected:
    ...
    quint64 m_ParaZKSetID;
    quint64 m_StatusZKSetID;
