#ifndef TTCDEVCTLINTERFACEGUI_H
#define TTCDEVCTLINTERFACEGUI_H
...
class TTCDEVCTLINTERFACESHARED_EXPORT TTCDevCtlInterfaceGUI : public ILxTsspShow
{
public:
    TTCDevCtlInterfaceGUI(TLxTsspObjectInfo ObjectInfo);
