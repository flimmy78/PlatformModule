...
#include "USBBBE_SysParaSetGUI_global.h"
...
#define MODULENAME ("USBBBE系统参数设置")

#define CMDNAME ("过程控制命令")

#define CMDNAME4 ("过程控制命令4")

#define SS1_TARGET_NUM ("扩频目标数")

class USBBBE_SYSPARASETGUISHARED_EXPORT USBBBE_SysParaSetGUI : public ILxTsspShow
{

public:
    USBBBE_SysParaSetGUI(TLxTsspObjectInfo ObjectInfo);
...
protected:
    ...
    quint64 m_ParaComSynID;      //公共参数单元界面ID
    quint64 m_StatusComSynID;    //公共单元状态数据元素ID
