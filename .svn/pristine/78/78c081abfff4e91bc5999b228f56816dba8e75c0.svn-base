...
public:
    ...
    //case 7://主跟踪单元
    SMCU::MCSSSTraceStatusStruct4* m_pTrace4_7;
    //case 8://扩频遥测模拟源参数设置
    ...
    void updateAbstract(SS1BBE_GlobalStatusStruct *pBbeAbstract);
    void updateAbstractIndex(SS1BBE_IndexStatusStruct &index, int target);
};
