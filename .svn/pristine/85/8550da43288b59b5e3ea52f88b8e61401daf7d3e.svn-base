...
#include "DDTBBE_QCodFrmSynSetGUI_global.h"
...
#define MODULENAME      ("数传解调参数设置")


class DDTBBE_CODFRMSYNSETGUISHARED_EXPORT DDTBBE_CodFrmSynSetGUI : public ILxTsspShow
{

public:
    DDTBBE_CodFrmSynSetGUI(TLxTsspObjectInfo ObjectInfo);
