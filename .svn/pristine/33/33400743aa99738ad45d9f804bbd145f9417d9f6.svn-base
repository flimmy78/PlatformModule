...
bool SS2BBE_ModuParamSetGUI::isAK(unsigned short localDID, int& connectIndex)
{
...
int SS2BBE_ModuParamSetGUI::CreateDefaultMacroObj(ILxTsspParameterMacro* pMacroObj)
{
    ...
    for (int i = 0; i < MAX_TARGET_COUNT; i++)
    {
        ...
        //遥测支路输出功率微调
        tmpModuPara.upModPara[i].m_MCSTargetTCSSUpModulParam.cPowAdjust = m_ParaSetStruct[i + 1][1].InitVal.lval;
        //遥测支路扩频码速率
