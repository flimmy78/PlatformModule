...
extern "C" int GetConfigFormat(QString& strConfigFormat)
{
    ...
    strConfigFormat = QString(
            "<Module Name=\"TMServerInterface.so\" StationID=\"2311\" SubSysID=\"01\" DevID=\"0400\" Note=\"%1\"> \n \
            <Object ID=\"5136\" Num=\"1\" IndexStart=\"0\" Alias =\" \" Note=\"%1\">...</Object> \n \
    ...
    for(int i=0; i<nodeList.length(); i++)
    {
        ...
        if(usObjID == 0x6021)
        {
            for(int k=iStart; k<iStop; k++)
            {
                ...
                strcpy(ObjectInfo.szConfigID, "D_Y17-92_211");
