...
#include "SS2BBE_TCParamSetGUI_global.h"
#include "../../Common/LxTsspCommonDefinition.h"

#include "../../Common/DataStruct2311.h"
#include "../../Common/DeviceMap.h"
#define MODULENAME  ("模式2遥控参数设置")

class SS2BBE_TCPARASETGUISHARED_EXPORT SS2BBE_TCParamSetGUI : public ILxTsspShow
{

public:
    SS2BBE_TCParamSetGUI(TLxTsspObjectInfo ObjectInfo);
