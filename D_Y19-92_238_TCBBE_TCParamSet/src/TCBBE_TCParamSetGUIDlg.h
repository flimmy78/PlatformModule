#ifndef TCBBE_TCPARASETGUIDLG_H
#define TCBBE_TCPARASETGUIDLG_H
...
namespace Ui {
class TCBBE_TCParamSetGUIDlg;
}

class TCBBE_TCParamSetGUIDlg : public QDialog
{
    Q_OBJECT

public:
    explicit TCBBE_TCParamSetGUIDlg(QWidget *parent = 0);
    QSize sizeHint() const;
    ~TCBBE_TCParamSetGUIDlg();
