...
#include "TCBBE_TCParamSetGUI_global.h"
#include "../../Common/LxTsspCommonDefinition.h"

#include "../../Common/DataStruct2311.h"
#include "../../Common/DeviceMap.h"
#define MODULENAME  ("单遥控遥控参数设置")

class TCBBE_TCPARASETGUISHARED_EXPORT TCBBE_TCParamSetGUI : public ILxTsspShow
{

public:
    TCBBE_TCParamSetGUI(TLxTsspObjectInfo ObjectInfo);
