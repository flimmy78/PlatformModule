...
#include "SS2BBE_CjCsParamSetGUI_global.h"
...
#define MODULENAME ("模式2测距测速参数设置")

class SS2BBE_CJCSPARAMSETGUISHARED_EXPORT SS2BBE_CjCsParamSetGUI : public ILxTsspShow
{

public:
    SS2BBE_CjCsParamSetGUI(TLxTsspObjectInfo ObjectInfo);
