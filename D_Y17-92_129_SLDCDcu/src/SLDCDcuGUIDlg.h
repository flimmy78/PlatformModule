#ifndef SLDCDCUGUIDLGDLG_H
#define SLDCDCUGUIDLGDLG_H
...
class SLDCDcuGUIDlg : public QDialog
{
    Q_OBJECT
public:
    explicit SLDCDcuGUIDlg(QWidget *parent = 0);
...
private:
    ...
    SLDCDCUPara m_SLDCDcuPara;  //测试开关矩阵状态参数
    SLDCDCUStatu *m_pSLDCDcuStatus;  //测试开关矩阵显示响应信息
