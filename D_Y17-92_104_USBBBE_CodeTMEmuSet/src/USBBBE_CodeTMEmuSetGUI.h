...
#include "USBBBE_CodeTMEmuSetGUI_global.h"
...
#define MODULENAME ("USBBBE模拟源参数设置")
#define AUTO_MAP_MODULENAME ("USBBBE遥测参数设置")

class USBBBE_CODETMEMUSETGUISHARED_EXPORT USBBBE_CodeTMEmuSetGUI : public ILxTsspShow
{

public:
    USBBBE_CodeTMEmuSetGUI(TLxTsspObjectInfo ObjectInfo);
