#ifndef TMDEVCTLINTERFACE_GLOBAL_H
#define TMDEVCTLINTERFACE_GLOBAL_H

#include <QtCore/qglobal.h>
//#pragma execution_character_set("utf-8")

#if defined(TMDEVCTLINTERFACESLATE_LIBRARY)
#  define TMDEVCTLINTERFACESHARED_EXPORT Q_DECL_EXPORT
#else
#  define TMDEVCTLINTERFACESHARED_EXPORT Q_DECL_IMPORT
#endif
...
//end 日志
#endif // TMDEVCTLINTERFACE_GLOBAL_H
