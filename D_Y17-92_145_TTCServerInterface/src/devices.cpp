...
void CNetSwitch::get(SNetSwitch& ns)
{
    memcpy(&ns.m_IFSWMatStatuResponse, m_pIFSWMatStatuResponse, sizeof(ns.m_IFSWMatStatuResponse));
}
...
//void CNetSwitch::set(SNetSwitch &m_IFSWMatStatuResponse)
//{
//    memcpy(m_pIFSWMatStatuResponse, m_IFSWMatStatuResponse, sizeof(m_IFSWMatStatuResponse));
//}
void CNetSwitch::processNetSwitch(QByteArray& datagram)
{
    m_connect = char(1);
