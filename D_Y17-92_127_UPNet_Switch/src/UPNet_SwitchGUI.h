...
#include "UPNet_SwitchGUI_global.h"
#include "../../Common/LxTsspCommonDefinition.h"
#include "../../Common/DataStruct2311.h"

#include "../../Common/DeviceMap.h"

#define MODULENAME      ("上行中频开关矩阵监控")


class UPNET_SWITCHGUISHARED_EXPORT UPNet_SwitchGUI : public ILxTsspShow
{
public:
    UPNet_SwitchGUI(TLxTsspObjectInfo ObjectInfo);
