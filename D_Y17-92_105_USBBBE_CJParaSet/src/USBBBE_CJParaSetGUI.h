...
#include "USBBBE_CJParaSetGUI_global.h"
#include "../../Common/LxTsspCommonDefinition.h"

#include "../../Common/DataStruct2311.h"
#include  "../../Common/DeviceMap.h"
#define MODULENAME      "USBBBE测距参数设置"


class USBBBE_CJPARASETGUISHARED_EXPORT USBBBE_CJParaSetGUI : public ILxTsspShow
{

public:
    USBBBE_CJParaSetGUI(TLxTsspObjectInfo ObjectInfo);
