...
#include "SS1BBE_RcvParamSetGUI_global.h"
...
#define MODULENAME ("模式1接收参数设置")

class SS1BBE_RCVPARAMSETGUISHARED_EXPORT SS1BBE_RcvParamSetGUI : public ILxTsspShow
{
public:
    SS1BBE_RcvParamSetGUI(TLxTsspObjectInfo ObjectInfo);
