...
#include "SS2BBE_RcvParamSetGUI_global.h"
...
#define MODULENAME ("模式2接收参数设置")

class SS2BBE_RCVPARAMSETGUISHARED_EXPORT SS2BBE_RcvParamSetGUI : public ILxTsspShow
{
public:
    SS2BBE_RcvParamSetGUI(TLxTsspObjectInfo ObjectInfo);
