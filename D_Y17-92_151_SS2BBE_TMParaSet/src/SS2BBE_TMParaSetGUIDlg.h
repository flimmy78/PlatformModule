#ifndef SS2BBE_TMPARASETGUIDLG_H
#define SS2BBE_TMPARASETGUIDLG_H
...
namespace Ui {
class SS2BBE_TMParaSetGUIDlg;
}

class SS2BBE_TMParaSetGUIDlg : public QDialog
{
    Q_OBJECT

public:
    explicit SS2BBE_TMParaSetGUIDlg(QWidget *parent = 0);
    QSize sizeHint() const;
    ~SS2BBE_TMParaSetGUIDlg();
...
#endif // SS2BBE_TMPARASETGUIDLG_H
