...
#include "SS2BBE_TMParaSetGUI_global.h"
#include "../../Common/LxTsspCommonDefinition.h"

#include "../../Common/DataStruct2311.h"
#include "../../Common/DeviceMap.h"
#define  MODULENAME ("扩频遥测解调参数设置")

class SS2BBE_TMPARASETGUISHARED_EXPORT SS2BBE_TMParaSetGUI : public ILxTsspShow
{

public:
    SS2BBE_TMParaSetGUI(TLxTsspObjectInfo ObjectInfo);
