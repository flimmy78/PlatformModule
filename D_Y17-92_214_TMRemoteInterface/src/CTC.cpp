...
#define DATA_SOURCE_ALLOC_D(_type, dataSource, moduleName, devID, index) \
    do{\
    ...
    qDebug()<<sItem->usDeviceID<<"*"<<sItem->usStateType<<"*"<<sItem->ucSN;\
...
//            DATA_SOURCE_ALLOC(SMCU2::MCSRevStatusStruct4, m_pMCSRevStatusStruct4_2, "模式2接收参数设置", deviceID,0)
    DATA_SOURCE_ALLOC_D(SMCU2::MCSSysTarget4StatusStruct, m_pMCSSysTarget4Status1, "单遥控系统工作参数设置", deviceID, 0)
...
void CTC::processBaseBoundData(BYTE *pBuff, const BYTE &unitNum)
{
    ...
    case 3://模式2调制参数设置
        ...
        break;
    case 5://扩频遥控参数设置
        //memcpy(m_pMCSSSB2TCStatu4_5, pBuff, sizeof(SMCU2::MCSSSB2TCStatusStruct4));
        break;
    case 9://模式2扩频码设置
