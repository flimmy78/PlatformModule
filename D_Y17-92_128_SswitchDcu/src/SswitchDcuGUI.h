...
#include "SswitchDcuGUI_global.h"
#include "../../Common/LxTsspCommonDefinition.h"
#include "../../Common/DataStruct2311.h"

#include "../../Common/DeviceMap.h"

#define MODULENAME      ("射频切换开关监控")

class SSWITCHDCUGUISHARED_EXPORT SswitchDcuGUI : public ILxTsspShow
{
public:
    SswitchDcuGUI(TLxTsspObjectInfo ObjectInfo);
