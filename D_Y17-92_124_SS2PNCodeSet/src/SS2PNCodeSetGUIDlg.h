#ifndef SS2PNCODESETGUIDLG_H
#define SS2PNCODESETGUIDLG_H
...
#include <QMessageBox>
namespace Ui {
class SS2PNCodeSetGUIDlg;
}

class SS2PNCodeSetGUIDlg : public QDialog
{
    Q_OBJECT

public:
    explicit SS2PNCodeSetGUIDlg(QWidget *parent = 0);
