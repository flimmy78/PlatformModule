...
#include "SS2PNCodeSetGUI_global.h"
#include "../../Common/LxTsspCommonDefinition.h"

#include "../../Common/DataStruct2311.h"
#include "../../Common/DeviceMap.h"
#define MODULENAME ("模式2扩频码设置")

//参数描述信息
class SS2PNCODESETGUISHARED_EXPORT SS2PNCodeSetGUI : public ILxTsspShow
{

public:
    SS2PNCodeSetGUI(TLxTsspObjectInfo ObjectInfo);
...
protected:
    ...
    quint64 m_ParaSS2PNCID;
    quint64 m_StatusSS2PNCID;
